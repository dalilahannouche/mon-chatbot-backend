...
const model = genAI.getGenerativeModel({
  model: "gemini-1.5-flash", // Flash supporte le streaming
  systemInstruction: `
    Profile Overview:
...
// Route test
app.get("/", (req, res) => res.send("API fonctionne correctement !"));

// Route POST pour le chatbot avec streaming SSE
app.post("/api/chat-stream", async (req, res) => {
  ...
  try {
    ...
    // Envoyer les chunks dès qu'ils arrivent
